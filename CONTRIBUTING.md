...
Dashboard migrations are functions in the `dashboardMigrations` array in `public/js/lib/dashboardMigrations.js`. Each function in this array corresponds to a new dashboard version.
